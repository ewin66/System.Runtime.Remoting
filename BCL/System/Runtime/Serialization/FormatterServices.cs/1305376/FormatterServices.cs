...
[System.Runtime.InteropServices.ComVisible(true)] 
    public sealed class FormatterServices {
        ...
        { 
            ...
            if (rtField != null)
            { 
                rtField.InternalSetValue(target, value, (BindingFlags)0, s_binder, null, false);
                return;
            }
            ...
            if (serField != null) 
            { 
                serField.InternalSetValue(target, value, (BindingFlags)0, s_binder, null, false, true);
                return; 
            }
